...
namespace Mirror
{
    ...
    public class NetworkManager : MonoBehaviour
    {
        ...
        [Command]
        public void CmdSendName(GameObject Name1, bool state1)
        {
            NetworkIdentity objNetId = Name1.GetComponent<NetworkIdentity>();
            objNetId.AssignClientAuthority(clientReadyConnection);
        }

        [ClientRpc]
        public void RpcSendName(GameObject Name2, bool state2)
        {
            Name2.GetComponent<MeshRenderer>().enabled = state2;
        }
